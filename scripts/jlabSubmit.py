...
#FIXME Update these
    ...
    outputDir = "/lustre/expphy/volatile/halla/parity/cameronc/prexSim/output/SAM_tests"
    nrEv   = 900000 #900000
    nrStart= 0
    nrStop = 56 #60
    ###format should be _Name
    identifier = "SAMs_noAl" #6inDonut_SAMs"  (spherical, cylindrical, noFace, noAl, noQ, noQnoAl)
#</FIXME>
