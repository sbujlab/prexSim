...
#FIXME Update these
    ...
    identifier = "SAMs_cyl_thickness"#raw_input("Please enter the identifier: ")
    thickness = raw_input("Please enter the thickness in mm (integers up to 13mm=1.3cm - or higher if needed): ")

    f = open('../geometry/SAMs_cyl_thickness.xml', 'w')
    fileout = '    <constant name="sam_quartz_height" value="' + thickness + '/10"/>\n'
    f.write(fileout)
    f.close()

    #sourceDir = "/work/halla/parity/disk1/ciprian/prexSim"
    sourceDir = "/work/halla/parity/disk1/moller12gev/cameronc/prexSim"
    outputDir = "/lustre/expphy/volatile/halla/parity/cameronc/prexSim/output/SAM_thickness_tests"
    nrEv   = 900000 #900000
    nrStart= 0
    nrStop = 10 #60
